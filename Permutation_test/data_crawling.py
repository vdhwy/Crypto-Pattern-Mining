...
# Setup parameters
symbol = 'BTCUSDT'
interval = '5m' # '1d' = Daily. You can change this to '1h' (hourly) or '1m' (minute)
start_date = '2017-08-17' # Earliest available BTCUSDT data on Binance
end_date = '2020-12-31'
...
filename = f"{symbol}_{interval}_2017_to_2020.csv"
