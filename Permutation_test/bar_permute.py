...
if __name__ == '__main__':
    ...
    btc_real = pd.read_csv('/Users/ad/Desktop/Testing/Stock_research/BTCUSDT_5m.csv', index_col='timestamp', parse_dates=True)

    btc_real = btc_real[(btc_real.index.year >= 2023) & (btc_real.index.year < 2025)]
    ...
    eth_real = pd.read_csv('/Users/ad/Desktop/Testing/Stock_research/LINKUSDT_5m.csv', index_col='timestamp', parse_dates=True)
    eth_real = eth_real[(eth_real.index.year >= 2023) & (eth_real.index.year < 2025)]
