...
df = pd.read_csv('/Users/ad/Desktop/Testing/Stock_research/BTCUSDT_5m_2017_to_2020.csv', 
                 index_col='timestamp', 
                 parse_dates=True)

train_df = df[(df.index.year >= 2017) & (df.index.year < 2020)]
...
plt.grid(False)
plt.legend()
plt.savefig('mcpt_test_results.jpeg', format='jpeg')
plt.show()